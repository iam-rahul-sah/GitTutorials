...
- `git checkout -- <file>` - This is another command used to unstage the file. `git checkout` directly moves a file from stagged section to the unmodified file section skipping the modified file section.
